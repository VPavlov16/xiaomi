...
<body>
   ...
   <div class="panel">
    ...
    <p>GPS?</p>
    <input type="radio" id="No" name="gps" value="No">
    <label for="No">No</label>
    <input type="radio" id="Yes" name="gps" value="Yes">
    <label for="Yes">Yes</label>
    <br>
    <p>Bluetooth?</p>
    <input type="radio" id="No" name="Bluetooth" value="No">
    <label for="No">No</label>
    <input type="radio" id="Bluetooth 5.1" name="Bluetooth" value="Bluetooth 5.1">
    <label for="Bluetooth 5.1">Bluetooth 5.1</label>
    <input type="radio" id="Bluetooth 5.2" name="Bluetooth" value="Bluetooth 5.2">
    <label for="Bluetooth 5.2">Bluetooth 5.2</label>
    <br>
    <label for="pic">Cover Picture</label>
    <br>
    <input id="text" type="file" name="pic" value="pic">
    <br>
    <label for="pic1">2nd Picture</label>
    <br>
    <input id="text" type="file" name="pic1" value="pic1">
    <br>
    <label for="pic2">3th Picture</label>
    <br>
    <input id="text" type="file" name="pic2" value="pic2">
    <br>
    <label for="pic3">4th Picture</label>
    <br>
    <input id="text" type="file" name="pic3" value="pic3">
    <br>
    <label for="pic4">5th Picture</label>
    <br>
    <input id="text" type="file" name="pic4" value="pic4">
    <br> <br>
