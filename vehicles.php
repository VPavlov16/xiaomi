...
<body>
    <nav>
        ...
        <ul>
            <li>
                <a href="#" class="logo-a">
                    <img src="images\logo-xiaomi.png" alt="logo" class="xiaomi">
            ...
            <div class="list">
            <li>
                <a href="mobdev.html" class="list-a">
        ...
        <div class="list">
            <li>
                <a href="vehicles.html" class="list-a">
        ...
        <div class="list">
            <li>
                <a href="wearable.html" class="list-a">
        ...
        <div class="list">
            <li>
                <a href="smdev.html" class="list-a">
